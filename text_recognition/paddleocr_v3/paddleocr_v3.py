...
# Parameters
# ======================
REMOTE_PATH_V1 = 'https://storage.googleapis.com/ailia-models/paddle_ocr/'
REMOTE_PATH_V3 = 'https://storage.googleapis.com/ailia-models/paddle_ocr_v3/'
...
def get_default_config():
    ...
    dc['det_algorithm'] = 'DB'
    dc['det_model_path'] = WEIGHT_PATH_DET_PPOCRV5_MBL
    ...
    dc['rec_model_path'] = WEIGHT_PATH_REC_PPOCRV5_MBL
    dc['rec_image_shape'] = '3, 48, 320'
    dc['rec_char_type'] = 'ch'
    dc['rec_batch_num'] = 6
    dc['max_text_length'] = 25
    dc['rec_char_dict_path'] = DICT_PATH_REC_PPOCRV5_MBL
...
def main():
    ...
    if args.case == 'mobile':
        ...
        logger.error('Unknown case: %s' % args.case)
        sys.exit(-1)
    ...
    check_and_download_models(weight_path_det, model_path_det, REMOTE_PATH_V3)
    model_path_cls = weight_path_cls + '.prototxt'
    check_and_download_models(weight_path_cls, model_path_cls, REMOTE_PATH_V1)
    model_path_rec = weight_path_rec + '.prototxt'
    check_and_download_models(weight_path_rec, model_path_rec, REMOTE_PATH_V3)
