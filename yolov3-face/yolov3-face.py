...
if not os.path.exists(model_path):
    urllib.request.urlretrieve("https://storage.googleapis.com/ailia-models/yolov3-face/"+model_path,model_path)
if not os.path.exists(weight_path):
    urllib.request.urlretrieve("https://storage.googleapis.com/ailia-models/yolov3-face/"+weight_path,weight_path)
...
for idx  in range(count) :
    ...
    print("  category=" + str(obj.category) + "[ " + face_category[obj.category] + " ]" )
    ...
    cv2.putText( work, face_category[obj.category], text_position, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255, 255), 1)
