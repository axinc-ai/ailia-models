...
from util1 import Boxes

#from densepose.structures import DensePoseChartResult, DensePoseChartResultWithConfidences
#from chart_result import DensePoseChartResult, DensePoseChartResultWithConfidences
...
class BaseConverter:
    ...
    def convert(cls, instance: Any, *args, **kwargs):
        ...
        print("instance type",instance_type,cls,converter)
