...
class Body(object):
    def __init__(self, model, is_onnx):
        self.model = model
...
class OpenposeDetector:
    def __init__(self, model, is_onnx):
        self.body_estimation = Body(model, is_onnx)
    ...
    def __call__(self, oriImg, hand_and_face=False, return_is_index=False):
        ...
        if hand_and_face:
            ...
            # Face
            faces_list = faceDetect(candidate, subset, oriImg)
...
class OpenPose:
    def __init__(self, model, is_onnx):
        self.preprocessor = OpenposeDetector(model, is_onnx)
