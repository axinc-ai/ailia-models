...
def main():
    ...
    if not args.onnx:
        ...
        net.set_input_blob_shape((1,PADDING_LEN),net.find_blob_index_by_name("token_type_ids"))
        net.set_input_blob_shape((1,PADDING_LEN),net.find_blob_index_by_name("input_ids"))
        net.set_input_blob_shape((1,PADDING_LEN),net.find_blob_index_by_name("attention_mask"))
    else:
    ...
    for text in s:
        ...
        for i in range(0,len(tokenized_text)):
            ...
            outputs = inference(net,tokenizer,tokenized_text,masked_index,original_text_len)
