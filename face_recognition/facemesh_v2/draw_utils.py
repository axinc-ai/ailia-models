...
FACEMESH_CONTOURS_CONNECTION_STYLE = {
    FACEMESH_LIPS:
        DrawingSpec(color=WHITE_COLOR, thickness=THICKNESS_CONTOURS),
    FACEMESH_LEFT_EYE:
        DrawingSpec(color=GREEN_COLOR, thickness=THICKNESS_CONTOURS),
    FACEMESH_LEFT_EYEBROW:
        DrawingSpec(color=GREEN_COLOR, thickness=THICKNESS_CONTOURS),
    FACEMESH_RIGHT_EYE:
        DrawingSpec(color=RED_COLOR, thickness=THICKNESS_CONTOURS),
...
def get_contours_style() -> Mapping[Tuple[int, int], DrawingSpec]:
    """
...
def get_tesselation_style() -> DrawingSpec:
    """
    Returns the default face mesh tesselation drawing style.
    """
    return DrawingSpec(color=GRAY_COLOR, thickness=THICKNESS_TESSELATION)


def get_iris_connections_style() \
    ...
    left_spec = DrawingSpec(color=GREEN_COLOR, thickness=THICKNESS_CONTOURS)
    for connection in FACEMESH_LEFT_IRIS:
        face_mesh_iris_connections_style[connection] = left_spec

    right_spec = DrawingSpec(color=RED_COLOR, thickness=THICKNESS_CONTOURS)
