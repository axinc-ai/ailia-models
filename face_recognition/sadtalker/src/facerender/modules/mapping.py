...
class MappingNet(nn.Module):
    ...
    def forward(self, input_3dmm):
        # print(input_3dmm.shape) # torch.Size([2, 70, 27])
        ...
        # print(yaw.shape) # torch.Size([2, 66])
        # print(pitch.shape) # torch.Size([2, 66])
        # print(roll.shape) # torch.Size([2, 66])
        # print(t.shape) # torch.Size([2, 3])
        # print(exp.shape) # torch.Size([2, 45])
