...
def ailia_face_detect(image, net_retinaface, arch):
    if arch == 'ailia-retinaface_resnet50':
        cfg = rut.cfg_re50
    elif arch == 'ailia-retinaface_mobile0.25':
        cfg = rut.cfg_mnet
    ...
    preds = net_retinaface.predict([image])
