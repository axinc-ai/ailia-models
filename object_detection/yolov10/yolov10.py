...
WEIGHT_YOLOV10N_PATH = 'yolov10n.onnx'
MODEL_YOLOV10N_PATH = 'yolov10n.onnx.prototxt'
WEIGHT_YOLOV10S_PATH = 'yolov10s.onnx'
MODEL_YOLOV10S_PATH = 'yolov10s.onnx.prototxt'
WEIGHT_YOLOV10M_PATH = 'yolov10m.onnx'
MODEL_YOLOV10M_PATH = 'yolov10m.onnx.prototxt'
WEIGHT_YOLOV10B_PATH = 'yolov10b.onnx'
MODEL_YOLOV10B_PATH = 'yolov10b.onnx.prototxt'
WEIGHT_YOLOV10L_PATH = 'yolov10l.onnx'
MODEL_YOLOV10L_PATH = 'yolov10l.onnx.prototxt'
WEIGHT_YOLOV10X_PATH = 'yolov10x.onnx'
MODEL_YOLOV10X_PATH = 'yolov10x.onnx.prototxt'

REMOTE_PATH = 'https://storage.googleapis.com/ailia-models/yolov10/'
...
parser = get_base_parser('YOLOv10', IMAGE_PATH, SAVE_IMAGE_PATH)
parser.add_argument(
    '-th', '--threshold',
...
parser.add_argument(
    '-m', '--model_type', default='v10x',
    choices=('v10n', 'v10s', 'v10m', 'v10b', 'v10l', 'v10x'),
    help='model type'
)
parser.add_argument(
    '--onnx',
...
def main():
    dic_model = {
        'v10n': (WEIGHT_YOLOV10N_PATH, MODEL_YOLOV10N_PATH),
        'v10s': (WEIGHT_YOLOV10S_PATH, MODEL_YOLOV10S_PATH),
        'v10m': (WEIGHT_YOLOV10M_PATH, MODEL_YOLOV10M_PATH),
        'v10b': (WEIGHT_YOLOV10B_PATH, MODEL_YOLOV10B_PATH),
        'v10l': (WEIGHT_YOLOV10L_PATH, MODEL_YOLOV10L_PATH),
        'v10x': (WEIGHT_YOLOV10X_PATH, MODEL_YOLOV10X_PATH),
    }
