...
WEIGHT_YOLOV12N_PATH = 'yolov12n.onnx'
MODEL_YOLOV12N_PATH = 'yolov12n.onnx.prototxt'
WEIGHT_YOLOV12S_PATH = 'yolov12s.onnx'
MODEL_YOLOV12S_PATH = 'yolov12s.onnx.prototxt'
WEIGHT_YOLOV12M_PATH = 'yolov12m.onnx'
MODEL_YOLOV12M_PATH = 'yolov12m.onnx.prototxt'
WEIGHT_YOLOV12L_PATH = 'yolov12l.onnx'
MODEL_YOLOV12L_PATH = 'yolov12l.onnx.prototxt'
WEIGHT_YOLOV12X_PATH = 'yolov12x.onnx'
MODEL_YOLOV12X_PATH = 'yolov12x.onnx.prototxt'
REMOTE_PATH = 'https://storage.googleapis.com/ailia-models/yolov12/'
...
parser = get_base_parser('YOLOv12', IMAGE_PATH, SAVE_IMAGE_PATH)
parser.add_argument(
    '-th', '--threshold',
...
parser.add_argument(
    '-m', '--model_type', default='v12x',
    choices=('v12n', 'v12s', 'v12m', 'v12l', 'v12x'),
    help='model type'
)
parser.add_argument(
    '--onnx',
...
def main():
    dic_model = {
        'v12n': (WEIGHT_YOLOV12N_PATH, MODEL_YOLOV12N_PATH),
        'v12s': (WEIGHT_YOLOV12S_PATH, MODEL_YOLOV12S_PATH),
        'v12m': (WEIGHT_YOLOV12M_PATH, MODEL_YOLOV12M_PATH),
        'v12l': (WEIGHT_YOLOV12L_PATH, MODEL_YOLOV12L_PATH),
        'v12x': (WEIGHT_YOLOV12X_PATH, MODEL_YOLOV12X_PATH)
    }
    WEIGHT_PATH, MODEL_PATH = dic_model[args.model_type]
    

    if args.model_type not in dic_model:
        logger.error(f"Invalid model type: {args.model_type}. Please choose from {list(dic_model.keys())}.")
        return
