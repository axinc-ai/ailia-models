...
if not os.path.exists(model_path):
    urllib.request.urlretrieve("https://storage.googleapis.com/ailia-models/googlenet/"+model_path,model_path)
if not os.path.exists(weight_path):
    urllib.request.urlretrieve("https://storage.googleapis.com/ailia-models/googlenet/"+weight_path,weight_path)
...
for idx  in range(count) :
    ...
    print("  category=" + str(info.category) + "[ " + googlenet_labels.imagenet_category[info.category] + " ]" )
